...
// Source: github.com/nori-io/nori-common/plugin (interfaces: Registry)
...
func (m *MockRegistry) Config() config.Manager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Config")
	ret0, _ := ret[0].(config.Manager)
	return ret0
}
...
func (m *MockRegistry) Logger(arg0 meta.Meta) logger.Writer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Logger", arg0)
	ret0, _ := ret[0].(logger.Writer)
	return ret0
}

// Logger indicates an expected call of Logger
func (mr *MockRegistryMockRecorder) Logger(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Logger", reflect.TypeOf((*MockRegistry)(nil).Logger), arg0)
}
