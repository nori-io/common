...
// Source: github.com/nori-io/common/v3/pkg/domain/meta (interfaces: Meta)
...
func (mr *MockMetaMockRecorder) GetID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetID", reflect.TypeOf((*MockMeta)(nil).GetID))
}
